...
export async function getRecipes(queryParam?: URLSearchParams): Promise<RecipeI[]> {
...
export async function updateRecipe(updatedRecipe: Partial<RecipeI>): Promise<RecipeI> {
...
export async function createRecipe(newRecipe: Partial<RecipeI>): Promise<RecipeI> {
